...
import 'package:city17_seller/source/features/offers/screens/active_tab_screens/active_bid_tab.dart';
import 'package:city17_seller/source/features/offers/screens/active_tab_screens/active_fixed_tab.dart';
    ...
    return Column(
      children: [
        ...
        Expanded(
          child: TabBarView(
            controller: _controller,
            children: [ActiveBidTab(), ActiveFixedTab()],
          ),
        ),
        SizedBox(height: 10),
      ],
